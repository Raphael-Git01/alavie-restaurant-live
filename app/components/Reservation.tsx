      ...
      <div className="max-w-2xl mx-auto px-6 text-center">
        ...
        <form onSubmit={handleSubmit} className="space-y-6 text-left">
          <div>
            ...
            <input type="text" className="w-full p-3 bg-stone-900 border border-stone-800 rounded focus:border-amber-500 outline-none text-white" required />
          </div>
          
          <div>
            <label className="block text-sm font-medium text-stone-300 mb-1">Your Email</label>
            <input type="email" className="w-full p-3 bg-stone-900 border border-stone-800 rounded focus:border-amber-500 outline-none text-white" required />
          </div>

          <div>
            <label className="block text-sm font-medium text-stone-300 mb-1">Special Requests or Feedback</label>
            <textarea 
              className="w-full p-3 bg-stone-900 border border-stone-800 rounded focus:border-amber-500 outline-none h-32 text-white"
